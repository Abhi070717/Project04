...
<body>
	...
	<div align="center">
		...
		<form action="<%=ORSView.FEATURE_LIST_CTL%>" method="post">
			<%
			...
			<table style="width: 100%">
				<tr>
					<td align="center"><label><b>Access Code:</b></label> <input
						type="text" name="code" placeholder="Enter Access Code"
			...
			<table border="1" style="width: 100%; border: groove;">
				<tr style="background-color: #e1e6f1e3;">
					...
					<th width="5%">S.No</th>
					<th width="25%">Access Code</th>
					<th width="25%">Audit Name</th>
