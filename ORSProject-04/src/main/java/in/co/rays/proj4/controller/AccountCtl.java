...
public class AccountCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		if (DataValidator.isNull(request.getParameter("name"))) {
			request.setAttribute("name", PropertyReader.getValue("error.require", "Account Name"));
			pass = false;
		}else if(!DataValidator.isName(request.getParameter("name"))) {
			request.setAttribute("name", "Invalid Account Name");
		}
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		bean.setAccountName(DataUtility.getString(request.getParameter("name")));
