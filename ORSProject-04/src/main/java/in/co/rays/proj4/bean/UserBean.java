...
/**
 * UserBean represents a user of the application. It stores user profile
 * information such as name, login credentials, date of birth, mobile number,
...
public class UserBean extends BaseBean {
	...
	/**
	 * Returns the display value for the user, typically their full name.
	 *
