...
public interface DropdownListBean {
	...
	/**
	 * Returns the unique key of the bean, typically used as the value attribute in
	 * HTML dropdowns.
	 *
	...
	/**
	 * Returns the display value of the bean, typically shown as the visible text in
	 * dropdown lists.
	 *
