...
public class FeatureListCtl extends BaseCtl {
	...
	protected void preload(HttpServletRequest request, HttpServletResponse response) {
		FeatureModel nameModel = new FeatureModel();
		try {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			List<FeatureBean> list = model.search(bean, pageNo, pageSize);
			List<FeatureBean> next = model.search(bean, pageNo + 1, pageSize);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (OP_SEARCH.equalsIgnoreCase(op)) {
				...
				pageNo = 1;
				FeatureBean deletebean = new FeatureBean();
