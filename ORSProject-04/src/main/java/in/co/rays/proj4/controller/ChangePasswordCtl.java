 ...
 * {@link in.co.rays.proj4.model.UserModel}. It also supports redirecting to the
 * user's profile page.
 * </p>
 * 
...
public class ChangePasswordCtl extends BaseCtl {
	 ...
	 * Validation rules:
	 * <ul>
	 * <li>If operation equals {@link #OP_CHANGE_MY_PROFILE} validation is
	 * skipped.</li>
	 * <li>oldPassword must be present.</li>
	 * <li>newPassword must be present, 8-12 characters and satisfy password
	 * complexity.</li>
	...
	/**
	 * Handles HTTP POST requests for changing the password or redirecting to the
	 * profile page.
	 * <p>
	 * If operation equals {@link BaseCtl#OP_SAVE} this method attempts to change
	 * the user's password via
	 * {@link UserModel#changePassword(long, String, String)}. On success, the
	 * updated user is loaded into session and a success message is set. If the user
	 * selects "Change My Profile" the method redirects to the profile controller.
	 * </p>
	 *
	 * @param request  the {@link HttpServletRequest}
	 * @param response the {@link HttpServletResponse}
