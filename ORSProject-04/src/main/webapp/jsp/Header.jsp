...
<body>
	...
	<a href="<%=ORSView.WELCOME_CTL%>"><img
		src="<%=request.getContextPath()%>/img/customLogo.jpg" align="right"
		width="100" height="40" border="0"></a>
	<%
	...
	<b>|</b>
	<a href="<%=ORSView.PATIENT_CTL%>"><b>Patient Appointment</b></a>
	<b>|</b>
	<a href="<%=ORSView.PATIENT_LIST_CTL%>"><b>Appointment List</b></a>
